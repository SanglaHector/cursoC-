...
namespace ComiqueriaLogic
{
    public sealed class Venta
    {
        ...
        {
            string precioformateado = Formateo.FormatearPrecio(this.precioFinal);
            return String.Format("{0} - {1} - {2}", this.fecha, this.producto.Descripcion,/* this.precioFinal*/ precioformateado);
        }        
    }
}
